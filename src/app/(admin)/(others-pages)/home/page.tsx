...
export default function FlightTrackerInfoPage() {
  return (
    <div className="bg-gray-100 p-4 sm:p-6">
      {/* TailAdmin Card Component */}
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Welcome to Flight Tracker</h1>
        ...
        <section className="mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-3">About Flight Tracker</h2>
        ...
        {/* Features Section */}
        <section className="mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-3">How It Works</h2>
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 sm:ml-4">
                <h3 className="text-base sm:text-lg font-medium text-gray-800">Airline Code (Required)</h3>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 sm:ml-4">
                <h3 className="text-base sm:text-lg font-medium text-gray-800">Flight Number (Optional)</h3>
                <p className="text-gray-600 text-sm sm:text-base">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 sm:ml-4">
                <h3 className="text-base sm:text-lg font-medium text-gray-800">Long-Haul Filter (Optional)</h3>
                <p className="text-gray-600 text-sm sm:text-base">
        ...
        <section className="text-center">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-3">Get Started</h2>
          <p className="text-gray-600 mb-4 text-sm sm:text-base">
            Ready to explore upcoming flights? Head over to the search page to start using Flight Tracker!
          </p>
          <a
            href="/flights"
            className="inline-block px-4 py-2 sm:px-6 sm:py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition duration-300"
          >
            Start Searching
          </a>
        </section>
